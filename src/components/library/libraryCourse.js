...
class LibraryCourse extends Component {
  ...
  handleCallback = function(status) {
    if(!status) {
      document.getElementById('library-course').classList.add('library-course-selcted');
    } else {
      document.getElementById('library-course').classList.remove('library-course-selcted');
    }
